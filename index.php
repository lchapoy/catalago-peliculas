        ...
        <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="post">
            <div class="form-group <?php echo (!empty($username_err)) ? 'has-error' : ''; ?>">
                ...
                <div class="input-group mb-2 mr-sm-2">
                    ...
                    <input type="text" name="username" class="form-control" value="<?php echo $username; ?>" aria-describedby="usernameHelpBlock">
                </div>
                <span id="usernameHelpBlock" class="help-block text-muted"><?php echo $username_err; ?></span>
            </div>    
            <div class="form-group <?php echo (!empty($password_err)) ? 'has-error' : ''; ?>">
                ...
                <span id="passwordHelpBlock" class="help-block text-muted" ><?php echo $password_err; ?></span>
            </div>
